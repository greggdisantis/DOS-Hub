...
export default function ReceiptCaptureScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: "Receipt Capture" }} />
      <ScreenContainer className="px-5" edges={["left", "right"]}>
        <View className="flex-1 items-center justify-center">
          <View style={[styles.iconContainer, { backgroundColor: "#10B981" + "18" }]}>
            <IconSymbol name="receipt" size={48} color="#10B981" />
          </View>
          <Text className="text-2xl font-bold text-foreground mt-5">Receipt Capture</Text>
          <Text className="text-sm text-muted mt-2 text-center px-8 leading-5">
            AI-powered expense tracking. Scan receipts with your camera and automatically extract vendor, date, and line-item data.
          </Text>
