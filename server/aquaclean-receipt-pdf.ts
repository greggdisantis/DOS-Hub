/**
 * Server-side AquaClean receipt PDF generator.
 * Produces an AquaClean-branded PDF:
...
export async function generateAquacleanReceiptPDF(receipt: ReceiptPDFData): Promise<Buffer> {
  return new Promise(async (resolve, reject) => {
    ...
    doc
      ...
      .fontSize(20)
      .font("Helvetica-Bold")
      .text("AquaClean", 50, 22);

    doc
      .fontSize(10)
      .font("Helvetica")
      .text("AquaClean Receipt Summary Report", 50, 48);
    ...
    doc
      ...
      .font("Helvetica")
      .text(
        `Generated by AquaClean · ${new Date().toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}`,
        50,
        footerY,
